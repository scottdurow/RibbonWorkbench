// ClientHooks.js
(function(){// Smartbuttons solution
// Version 1.0.0.0
//! Script# Core Runtime
(function () {
    var globals = {
...
Xrm.DelegateItterator.$0 = function ($p0, $p1, $p2, $p3, $p4) {
    if ($p1 < $p2) {
        try {
            $p0($p1, function () {
                $p1++; Xrm.DelegateItterator.$0($p0, $p1, $p2, $p3, $p4);
            }, function ($p1_0) {
                $p4($p1_0);
            });
        } catch ($0) { $p4($0); }
...
Xrm.Sdk.OrganizationServiceProxy.$B = function ($p0, $p1, $p2) {
    var $0 = ($p2 != null); var $1 = Xrm.Sdk.OrganizationServiceProxy.$9($p0); var $2 = null; var $3 = new XMLHttpRequest(); $3.open('POST', Xrm.Sdk.OrganizationServiceProxy.$A() + '/XRMServices/2011/Organization.svc/web', $0); $3.setRequestHeader('SOAPAction', 'http://schemas.microsoft.com/xrm/2011/Contracts/Services/IOrganizationService/' + $p1); $3.setRequestHeader('Content-Type', 'text/xml; charset=utf-8'); if (Xrm.Sdk.OrganizationServiceProxy.withCredentials) { $3.withCredentials = true;; } if ($0) {
    $3.onreadystatechange = function () {
        if ($3 == null) { return; } if ($3.readyState === 4) { var $1_0 = $3.responseXML; var $1_1 = null; if ($3.status !== 200) { $1_1 = Xrm.Sdk.OrganizationServiceProxy.$C($1_0); } delete $3; $3 = null; if ($1_1 != null) { $p2($1_1); } else { $p2($1_0); } }
    }; $3.send($1); return null;
    } else { $3.send($1); var $4 = $3.responseXML; if ($3.status !== 200) { $2 = Xrm.Sdk.OrganizationServiceProxy.$C($4); } delete $3;; $3 = null; if ($2 != null) { throw $2; } else { return $4; } }
}
...
Type.registerNamespace('SmartButtons.ClientHooks');ResourceStrings=function(){}
SmartButtons.ClientHooks.SmartButtons=function(){}
SmartButtons.ClientHooks.SmartButtons.RunReport=function(reportName,recordId,etc){var $0=String.format("<fetch count='1'>\r\n                       <entity name='report'>\r\n                           <attribute name='reportid'/>\r\n                           <filter type='and'>\r\n                               <condition attribute='name' operator='eq' value='{0}'/>\r\n                           </filter>\r\n                       </entity>\r\n                   </fetch>",reportName);Xrm.Sdk.OrganizationServiceProxy.beginRetrieveMultiple($0,function($p1_0){
var $1_0=Xrm.Sdk.OrganizationServiceProxy.endRetrieveMultiple($p1_0,Xrm.Sdk.Entity);var $enum1=ss.IEnumerator.getEnumerator($1_0.get_entities());while($enum1.moveNext()){var $1_1=$enum1.current;var $1_2=$1_1.id;var $1_3=Xrm.Page.context.getClientUrl();var $1_4=$1_3+'/crmreports/viewer/viewer.aspx?action=run&id=%7b'+encodeURIComponent($1_2)+'%7d&records=%7b'+recordId+'%7d&recordstype='+etc;window.open($1_4);break;}});}
SmartButtons.ClientHooks.SmartButtons.RunDialog=function(name,entityId,entityLogicalName){var $0=String.format("<fetch count='1'>\r\n                       <entity name='workflow'>\r\n                           <attribute name='workflowid'/>\r\n                           <filter type='and'>\r\n                               <condition attribute='name' operator='eq' value='{0}'/>\r\n                               <condition attribute='primaryentityname' operator='eq' value='{1}'/>\r\n                               <condition attribute='ondemand' operator='eq' value='true'/>\r\n                               <condition attribute='statuscode' operator='eq' value='2'/> \r\n                               <condition attribute='type' operator='eq' value='1'/>     \r\n                           </filter>\r\n                       </entity>\r\n                   </fetch>",name,entityLogicalName);Xrm.Sdk.OrganizationServiceProxy.beginRetrieveMultiple($0,function($p1_0){
var $1_0=Xrm.Sdk.OrganizationServiceProxy.endRetrieveMultiple($p1_0,Xrm.Sdk.Entity);var $enum1=ss.IEnumerator.getEnumerator($1_0.get_entities());while($enum1.moveNext()){var $1_1=$enum1.current;var $1_2=Xrm.Page.context.getClientUrl()+'/cs/dialog/rundialog.aspx?DialogId='+$1_1.getAttributeValueGuid('workflowid').toString()+'&EntityName='+entityLogicalName+'&ObjectId='+entityId;window.open($1_2);return;}});}
SmartButtons.ClientHooks.SmartButtons.QuickJavascript=function(entityIds,javascript){var $0=JSON.stringify(entityIds);eval(javascript.replaceAll('%ids%',$0));}
SmartButtons.ClientHooks.SmartButtons.RunWorkflowMultiple=function(name,entityIds,confirmationMessage,completeCallback,errorCalback){if(!String.isNullOrEmpty(confirmationMessage)){Xrm.Utility.confirmDialog(String.format(confirmationMessage,entityIds.length),function(){
SmartButtons.ClientHooks.SmartButtons.RunWorkflowMultiple(name,entityIds,null,completeCallback,errorCalback);},null);return;}var $enum1=ss.IEnumerator.getEnumerator(entityIds);while($enum1.moveNext()){var $0=$enum1.current;SmartButtons.ClientHooks.SmartButtons.RunWorkflowSingle(name,[$0],null,completeCallback,errorCalback);}}
SmartButtons.ClientHooks.SmartButtons.RunWorkflowSingle=function(name,entityIds,confirmationMessage,completeCallback,errorCallback){if(!String.isNullOrEmpty(confirmationMessage)){Xrm.Utility.confirmDialog(confirmationMessage,function(){
SmartButtons.ClientHooks.SmartButtons.RunWorkflowSingle(name,entityIds,null,completeCallback,errorCallback);},null);return;}else{var $enum1=ss.IEnumerator.getEnumerator(entityIds);while($enum1.moveNext()){var $0=$enum1.current;SmartButtons.ClientHooks.SmartButtons.RunWorkflow(name,$0,completeCallback,errorCallback);}}}
SmartButtons.ClientHooks.SmartButtons.RunWorkflow=function(name,entityId,completeCallback,errorCallback){var $0=String.format("<fetch count='1'>\r\n                       <entity name='workflow'>\r\n                           <attribute name='workflowid'/>\r\n                           <filter type='and'>\r\n                               <condition attribute='name' operator='eq' value='{0}'/>\r\n                               <condition attribute='ondemand' operator='eq' value='true'/>\r\n                               <condition attribute='statuscode' operator='eq' value='2'/> \r\n                               <condition attribute='type' operator='eq' value='1'/>     \r\n                           </filter>\r\n                       </entity>\r\n                   </fetch>",name);Xrm.Sdk.OrganizationServiceProxy.beginRetrieveMultiple($0,function($p1_0){
var $1_0=Xrm.Sdk.OrganizationServiceProxy.endRetrieveMultiple($p1_0,Xrm.Sdk.Entity);if(!$1_0.get_entities().get_count()){Xrm.Page.ui.setFormNotification('Workflow '+name+' is not published','ERROR','RibbonWorkflowError');}var $enum1=ss.IEnumerator.getEnumerator($1_0.get_entities());while($enum1.moveNext()){var $1_1=$enum1.current;var $1_2=new Xrm.Sdk.Messages.ExecuteWorkflowRequest();$1_2.entityId=entityId.replaceAll('{','').replaceAll('}','');$1_2.workflowId=$1_1.getAttributeValueString('workflowid');Xrm.Sdk.OrganizationServiceProxy.beginExecute($1_2,function($p2_0){
try{var $2_0=Xrm.Sdk.OrganizationServiceProxy.endExecute($p2_0);if(completeCallback!=null){if($2_0.id===Xrm.Sdk.Guid.empty.value){eval(completeCallback);}else{SmartButtons.ClientHooks.SmartButtons.WaitForWorkflowToComplete($2_0.id,completeCallback,errorCallback,null);}}}catch($2_1){var $2_2=$2_1.stack;console.log(stackTrace);eval(errorCallback);}});break;}});}
SmartButtons.ClientHooks.SmartButtons.WaitForWorkflowToComplete=function(asyncoperationid,callbackFunction,errorCallback,startTime){if(startTime==null){startTime=Date.get_now();}Xrm.Sdk.OrganizationServiceProxy.beginRetrieve('asyncoperation',asyncoperationid,['statecode','statuscode'],function($p1_0){
var $1_0=Xrm.Sdk.OrganizationServiceProxy.endRetrieve($p1_0,Xrm.Sdk.Entity);var $1_1=$1_0.getAttributeValueOptionSet('statuscode');if($1_1!=null&&$1_1.value===30){eval(callbackFunction);}else if(($1_1!=null&&$1_1.value>=31)||((Date.get_now()-startTime)>180000)){eval(errorCallback);}else{window.setTimeout(function(){
SmartButtons.ClientHooks.SmartButtons.WaitForWorkflowToComplete(asyncoperationid,callbackFunction,errorCallback,startTime);},1000);}});}
ResourceStrings.registerClass('ResourceStrings');SmartButtons.ClientHooks.SmartButtons.registerClass('SmartButtons.ClientHooks.SmartButtons');ResourceStrings.confirmWorkflow='Are you sure you want to run the workflow';ResourceStrings.confirmWorkflowMultiple='Are you sure you want to run the workflow on {0} record(s)?';})();